            ...
            <div class="row">
				<div class="col-lg-12">
                    <div class="panel panel-primary">
						...
						<div class="form">
						<form class="form-validate form-horizontal" method="post" action="<?php echo site_url('penjualan/transaksi')?>">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button type="submit" name="submit" class="btn btn-outline btn-primary">Simpan</button>  <?php echo anchor('penjualan/selesaiBelanja','Selesai',array('class'=>'btn btn-outline btn-success'))?>
                                    </div>
                                </div>
							</form>
							</div>
									...
									id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Rp. <?php echo number_format($row->harga_jual).' - '.
												anchor('penjualan/hapusItem/'.$row->id_detail_pjl,'Hapus',
